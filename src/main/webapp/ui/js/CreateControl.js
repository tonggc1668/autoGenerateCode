...
function refreshData(total,details,data){
	...
	if(data!=null&&data!=undefined){
	 var time0 = JSON.stringify(data[0]);
	 var time1 = JSON.stringify(data[1]);
	 
	 time0=time0.substr(1,16);
	 time1=time1.substr(1,16);
	ReportViewer.Report.ParameterByName("fromdate").AsString =time0;
	ReportViewer.Report.ParameterByName("todate").AsString  =time1;
}
	totalRec = 	total;				
...
function refreshDataforsec(total,details,data){
	var records  = { "recordset":details }	
	/*if(params){
		records.add(params)
		= { "recordset":details, 
	...
	if(data!=null&&data!=undefined){
	 var time0 = JSON.stringify(data[0]);
	 var time1 = JSON.stringify(data[1]);
	 time0=time0.substr(1,10);
	 time1=time1.substr(1,10);
	ReportViewer.Report.ParameterByName("fromdate").AsString =time0;
	ReportViewer.Report.ParameterByName("todate").AsString  =time1;
}
	totalRec = 	total;				
