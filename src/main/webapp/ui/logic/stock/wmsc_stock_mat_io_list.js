...
var listTemplate = '#wmsc_stock_mat_io_list';
var formSearchTemplate = '#wmsc_stock_mat_io_searchForm';
var gridMenuId = '#wmsc_stock_mat_io_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_stock_mat_io_list',
		objectName:'商品日进销存',
		objectKeys:['busi_date'],
		objectFields:
				[
				...
				{field:'mat_id',name:'商品id',ctrlType:'easyui-numberbox',hidden:false},
				...
				{field:'wh_start_quant',name:'本日起始量',ctrlType:'easyui-numberbox',hidden:false},
				{field:'wh_in_quant',name:'本日入库量',ctrlType:'easyui-numberbox',hidden:false},
				{field:'wh_out_quant',name:'本日出库量',ctrlType:'easyui-numberbox',hidden:false},
				{field:'wh_loss_quant',name:'本日盈亏量',ctrlType:'easyui-numberbox',hidden:false},
				{field:'wh_end_quant',name:'本日结余量',ctrlType:'easyui-numberbox',hidden:false},
		...
		actionForms:{
			'wmsc_stock_mat_io_addData':{formId:'wmsc_stock_mat_io_add_form',formUrl:'ui/view/stock/wmsc_stock_mat_io_add_form.html?actionId=wmsc_stock_mat_io_add_form'},
			'wmsc_stock_mat_io_getData':{formId:'wmsc_stock_mat_io_query_form',formUrl:'ui/view/stock/wmsc_stock_mat_io_query_form.html?actionId=wmsc_stock_mat_io_query_form'},
			'wmsc_stock_mat_io_updateData':{formId:'wmsc_stock_mat_io_update_form',formUrl:'ui/view/stock/wmsc_stock_mat_io_update_form.html?actionId=wmsc_stock_mat_io_update_form'}
			},
		expellActions:{
			'wmsc_stock_mat_io_searchData':'',
			'wmsc_stock_mat_io_exportEntities':''
			}

};
var searchMeta = [
				{field:'busi_date',name:'业务日期',ctrlType:'easyui-datebox',ddicTable:'',domainId:'',searchFlag:'EQ',mustFlag:'N',defaultValue:''},
];
var bda_data_str_field = {
            wmsc_stock_mat_io_addData : function (buttonId,actionUrl){
            ...
            wmsc_stock_mat_io_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_stock_mat_io_exportData : function (buttonId,actionUrl){
            ...
            wmsc_stock_mat_io_getData : function (buttonId,actionUrl){
            ...
            wmsc_stock_mat_io_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_stock_mat_io_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_stock_mat_io_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_stock_mat_io_getData'];
					techParam.initActionId = 'wmsc_stock_mat_io_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
