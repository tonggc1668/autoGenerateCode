...
var listTemplate = '#wmsc_busi_inbound_actual_list';
var formSearchTemplate = '#wmsc_busi_inbound_actual_searchForm';
var gridMenuId = '#wmsc_busi_inbound_actual_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_busi_inbound_actual_list',
		objectName:'入库货品执行明细',
		...
		objectFields:
				...
				{field:'actual_in_quant',name:'实际入库数量',ctrlType:'easyui-numberbox',hidden:false},
		...
		actionForms:{
			'wmsc_busi_inbound_actual_addData':{formId:'wmsc_busi_inbound_actual_add_form',formUrl:'ui/view/busi/wmsc_busi_inbound_actual_add_form.html?actionId=wmsc_busi_inbound_actual_add_form'},
			'wmsc_busi_inbound_actual_getData':{formId:'wmsc_busi_inbound_actual_query_form',formUrl:'ui/view/busi/wmsc_busi_inbound_actual_query_form.html?actionId=wmsc_busi_inbound_actual_query_form'},
			'wmsc_busi_inbound_actual_updateData':{formId:'wmsc_busi_inbound_actual_update_form',formUrl:'ui/view/busi/wmsc_busi_inbound_actual_update_form.html?actionId=wmsc_busi_inbound_actual_update_form'}
			},
		expellActions:{
			'wmsc_busi_inbound_actual_searchData':'',
			'wmsc_busi_inbound_actual_exportEntities':''
			}
...
var bda_data_str_field = {
            wmsc_busi_inbound_actual_addData : function (buttonId,actionUrl){
            ...
            wmsc_busi_inbound_actual_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_busi_inbound_actual_exportData : function (buttonId,actionUrl){
            ...
            wmsc_busi_inbound_actual_getData : function (buttonId,actionUrl){
            ...
            wmsc_busi_inbound_actual_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_busi_inbound_actual_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_busi_inbound_actual_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_busi_inbound_actual_getData'];
					techParam.initActionId = 'wmsc_busi_inbound_actual_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
