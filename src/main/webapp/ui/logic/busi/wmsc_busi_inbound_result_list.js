...
var listTemplate = '#wmsc_busi_inbound_result_list';
var formSearchTemplate = '#wmsc_busi_inbound_result_searchForm';
var gridMenuId = '#wmsc_busi_inbound_result_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_busi_inbound_result_list',
		objectName:'入库业务执行结果',
		objectKeys:['doc_id'],
		objectFields:
				[
		...
		actionForms:{
			'wmsc_busi_inbound_result_addData':{formId:'wmsc_busi_inbound_result_add_form',formUrl:'ui/view/busi/wmsc_busi_inbound_result_add_form.html?actionId=wmsc_busi_inbound_result_add_form'},
			'wmsc_busi_inbound_result_getData':{formId:'wmsc_busi_inbound_result_query_form',formUrl:'ui/view/busi/wmsc_busi_inbound_result_query_form.html?actionId=wmsc_busi_inbound_result_query_form'},
			'wmsc_busi_inbound_result_updateData':{formId:'wmsc_busi_inbound_result_update_form',formUrl:'ui/view/busi/wmsc_busi_inbound_result_update_form.html?actionId=wmsc_busi_inbound_result_update_form'}
			},
		expellActions:{
			'wmsc_busi_inbound_result_searchData':'',
			'wmsc_busi_inbound_result_exportEntities':''
			}
...
var bda_data_str_field = {
            wmsc_busi_inbound_result_addData : function (buttonId,actionUrl){
            ...
            wmsc_busi_inbound_result_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_busi_inbound_result_exportData : function (buttonId,actionUrl){
            ...
            wmsc_busi_inbound_result_getData : function (buttonId,actionUrl){
            ...
            wmsc_busi_inbound_result_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_busi_inbound_result_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_busi_inbound_result_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_busi_inbound_result_getData'];
					techParam.initActionId = 'wmsc_busi_inbound_result_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
