...
var listTemplate = '#wmsc_busi_outbound_plan_list';
var formSearchTemplate = '#wmsc_busi_outbound_plan_searchForm';
var gridMenuId = '#wmsc_busi_outbound_plan_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_busi_outbound_plan_list',
		objectName:'出库货品执行计划',
		objectKeys:['doc_id','mat_id'],
		objectFields:
				[
				...
				{field:'plan_out_quant',name:'预计出库数量',ctrlType:'easyui-numberbox',hidden:false},
				{field:'op_memo1',name:'操作要求1',ctrlType:'easyui-validatebox',hidden:false},
				{field:'op_memo2',name:'操作要求2',ctrlType:'easyui-validatebox',hidden:false},
				{field:'op_memo3',name:'操作要求3',ctrlType:'easyui-validatebox',hidden:false},
				{field:'op_memo4',name:'操作要求4',ctrlType:'easyui-validatebox',hidden:false},
				{field:'op_memo5',name:'操作要求5',ctrlType:'easyui-validatebox',hidden:false},
		...
		actionForms:{
			'wmsc_busi_outbound_plan_addData':{formId:'wmsc_busi_outbound_plan_add_form',formUrl:'ui/view/busi/wmsc_busi_outbound_plan_add_form.html?actionId=wmsc_busi_outbound_plan_add_form'},
			'wmsc_busi_outbound_plan_getData':{formId:'wmsc_busi_outbound_plan_query_form',formUrl:'ui/view/busi/wmsc_busi_outbound_plan_query_form.html?actionId=wmsc_busi_outbound_plan_query_form'},
			'wmsc_busi_outbound_plan_updateData':{formId:'wmsc_busi_outbound_plan_update_form',formUrl:'ui/view/busi/wmsc_busi_outbound_plan_update_form.html?actionId=wmsc_busi_outbound_plan_update_form'}
			},
		expellActions:{
			'wmsc_busi_outbound_plan_searchData':'',
			'wmsc_busi_outbound_plan_exportEntities':''
			}
...
var bda_data_str_field = {
            wmsc_busi_outbound_plan_addData : function (buttonId,actionUrl){
            ...
            wmsc_busi_outbound_plan_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_busi_outbound_plan_exportData : function (buttonId,actionUrl){
            ...
            wmsc_busi_outbound_plan_getData : function (buttonId,actionUrl){
            ...
            wmsc_busi_outbound_plan_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_busi_outbound_plan_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_busi_outbound_plan_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_busi_outbound_plan_getData'];
					techParam.initActionId = 'wmsc_busi_outbound_plan_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
