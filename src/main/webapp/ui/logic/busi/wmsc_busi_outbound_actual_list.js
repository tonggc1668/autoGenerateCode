...
var listTemplate = '#wmsc_busi_outbound_actual_list';
var formSearchTemplate = '#wmsc_busi_outbound_actual_searchForm';
var gridMenuId = '#wmsc_busi_outbound_actual_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_busi_outbound_actual_list',
		objectName:'出库货品执行明细',
		objectKeys:['doc_id','mat_id','occ_order'],
		objectFields:
				[
				...
				{field:'occ_order',name:'执行序号',ctrlType:'easyui-numberbox',hidden:false},
				...
				{field:'delivery_id',name:'物流单号',ctrlType:'easyui-validatebox',hidden:false},
				{field:'carrior_id',name:'承运商id',ctrlType:'easyui-numberbox',hidden:false},
				{field:'pack_type',name:'包装类别',ctrlType:'easyui-validatebox',hidden:false},
				...
				{field:'actual_out_quant',name:'实际出库数量',ctrlType:'easyui-numberbox',hidden:false},
				{field:'actual_out_time',name:'实际开始时间',ctrlType:'easyui-datetimebox',hidden:false},
				{field:'close_time',name:'实际完结时间',ctrlType:'easyui-datetimebox',hidden:false},
		...
		actionForms:{
			'wmsc_busi_outbound_actual_addData':{formId:'wmsc_busi_outbound_actual_add_form',formUrl:'ui/view/busi/wmsc_busi_outbound_actual_add_form.html?actionId=wmsc_busi_outbound_actual_add_form'},
			'wmsc_busi_outbound_actual_getData':{formId:'wmsc_busi_outbound_actual_query_form',formUrl:'ui/view/busi/wmsc_busi_outbound_actual_query_form.html?actionId=wmsc_busi_outbound_actual_query_form'},
			'wmsc_busi_outbound_actual_updateData':{formId:'wmsc_busi_outbound_actual_update_form',formUrl:'ui/view/busi/wmsc_busi_outbound_actual_update_form.html?actionId=wmsc_busi_outbound_actual_update_form'}
			},
		expellActions:{
			'wmsc_busi_outbound_actual_searchData':'',
			'wmsc_busi_outbound_actual_exportEntities':''
			}
...
var searchMeta = [
				...
				{field:'occ_order',name:'执行序号',ctrlType:'easyui-numberbox',ddicTable:'',domainId:'',searchFlag:'EQ',mustFlag:'N',defaultValue:''},
];
var bda_data_str_field = {
            wmsc_busi_outbound_actual_addData : function (buttonId,actionUrl){
            ...
            wmsc_busi_outbound_actual_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_busi_outbound_actual_exportData : function (buttonId,actionUrl){
            ...
            wmsc_busi_outbound_actual_getData : function (buttonId,actionUrl){
            ...
            wmsc_busi_outbound_actual_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_busi_outbound_actual_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_busi_outbound_actual_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_busi_outbound_actual_getData'];
					techParam.initActionId = 'wmsc_busi_outbound_actual_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
