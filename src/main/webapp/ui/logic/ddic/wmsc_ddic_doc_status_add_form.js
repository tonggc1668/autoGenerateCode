//-------------------- 代码可变区
//-------------------- 代码可变区
var formTemplate = '#form_wmsc_ddic_doc_status';
var fields = 
				[
				{field:'doc_status',name:'业务单状态',ctrlType:'easyui-combobox',ddicTable:'',domainId:'',display:'Y',mustFlag:'Y',minLen:0,maxLen:6,precise:0,readOnly:'N',defaultValue:''},
				{field:'doc_status_name',name:'业务单状态名称',ctrlType:'easyui-validatebox',ddicTable:'',domainId:'',display:'Y',mustFlag:'N',minLen:0,maxLen:32,precise:0,readOnly:'N',defaultValue:''},
				];
