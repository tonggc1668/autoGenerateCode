//-------------------- 代码可变区
//-------------------- 代码可变区
var formTemplate = '#form_wmsc_ddic_mat_unit';
var fields = 
				[
				{field:'mat_unit',name:'计量单位',ctrlType:'easyui-combobox',ddicTable:'',domainId:'',display:'Y',mustFlag:'Y',minLen:0,maxLen:6,precise:0,readOnly:'N',defaultValue:''},
				{field:'mat_unit_name',name:'计量单位名称',ctrlType:'easyui-validatebox',ddicTable:'',domainId:'',display:'Y',mustFlag:'N',minLen:0,maxLen:32,precise:0,readOnly:'N',defaultValue:''},
				];
