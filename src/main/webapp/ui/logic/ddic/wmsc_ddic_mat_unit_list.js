...
var listTemplate = '#wmsc_ddic_mat_unit_list';
var formSearchTemplate = '#wmsc_ddic_mat_unit_searchForm';
var gridMenuId = '#wmsc_ddic_mat_unit_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_ddic_mat_unit_list',
		objectName:'计量单位',
		objectKeys:['mat_unit'],
		objectFields:
				[
				{field:'mat_unit',name:'计量单位',ctrlType:'easyui-combobox',hidden:false},
				{field:'mat_unit_name',name:'计量单位名称',ctrlType:'easyui-validatebox',hidden:false},
		...
		actionForms:{
			'wmsc_ddic_mat_unit_addData':{formId:'wmsc_ddic_mat_unit_add_form',formUrl:'ui/view/ddic/wmsc_ddic_mat_unit_add_form.html?actionId=wmsc_ddic_mat_unit_add_form'},
			'wmsc_ddic_mat_unit_getData':{formId:'wmsc_ddic_mat_unit_query_form',formUrl:'ui/view/ddic/wmsc_ddic_mat_unit_query_form.html?actionId=wmsc_ddic_mat_unit_query_form'},
			'wmsc_ddic_mat_unit_updateData':{formId:'wmsc_ddic_mat_unit_update_form',formUrl:'ui/view/ddic/wmsc_ddic_mat_unit_update_form.html?actionId=wmsc_ddic_mat_unit_update_form'}
			},
		expellActions:{
			'wmsc_ddic_mat_unit_searchData':'',
			'wmsc_ddic_mat_unit_exportEntities':''
			}

};
var searchMeta = [
				{field:'mat_unit',name:'计量单位',ctrlType:'easyui-combobox',ddicTable:'',domainId:'',searchFlag:'EQ',mustFlag:'N',defaultValue:''},
];
var bda_data_str_field = {
            wmsc_ddic_mat_unit_addData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_mat_unit_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_mat_unit_exportData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_mat_unit_getData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_mat_unit_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_ddic_mat_unit_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_ddic_mat_unit_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_ddic_mat_unit_getData'];
					techParam.initActionId = 'wmsc_ddic_mat_unit_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
