...
var listTemplate = '#wmsc_ddic_wh_trans_list';
var formSearchTemplate = '#wmsc_ddic_wh_trans_searchForm';
var gridMenuId = '#wmsc_ddic_wh_trans_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_ddic_wh_trans_list',
		objectName:'仓库事务编码',
		objectKeys:['wh_trans'],
		objectFields:
				[
				{field:'wh_trans',name:'事务编码',ctrlType:'easyui-validatebox',hidden:false},
				{field:'wh_trans_name',name:'事务编码名称',ctrlType:'easyui-validatebox',hidden:false},
		...
		actionForms:{
			'wmsc_ddic_wh_trans_addData':{formId:'wmsc_ddic_wh_trans_add_form',formUrl:'ui/view/ddic/wmsc_ddic_wh_trans_add_form.html?actionId=wmsc_ddic_wh_trans_add_form'},
			'wmsc_ddic_wh_trans_getData':{formId:'wmsc_ddic_wh_trans_query_form',formUrl:'ui/view/ddic/wmsc_ddic_wh_trans_query_form.html?actionId=wmsc_ddic_wh_trans_query_form'},
			'wmsc_ddic_wh_trans_updateData':{formId:'wmsc_ddic_wh_trans_update_form',formUrl:'ui/view/ddic/wmsc_ddic_wh_trans_update_form.html?actionId=wmsc_ddic_wh_trans_update_form'}
			},
		expellActions:{
			'wmsc_ddic_wh_trans_searchData':'',
			'wmsc_ddic_wh_trans_exportEntities':''
			}

};
var searchMeta = [
				{field:'wh_trans',name:'事务编码',ctrlType:'easyui-validatebox',ddicTable:'',domainId:'',searchFlag:'EQ',mustFlag:'N',defaultValue:''},
];
var bda_data_str_field = {
            wmsc_ddic_wh_trans_addData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_wh_trans_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_wh_trans_exportData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_wh_trans_getData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_wh_trans_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_ddic_wh_trans_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_ddic_wh_trans_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_ddic_wh_trans_getData'];
					techParam.initActionId = 'wmsc_ddic_wh_trans_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
