...
var listTemplate = '#wmsc_ddic_cust_status_list';
var formSearchTemplate = '#wmsc_ddic_cust_status_searchForm';
var gridMenuId = '#wmsc_ddic_cust_status_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_ddic_cust_status_list',
		objectName:'客户业务状态',
		objectKeys:['cust_status'],
		objectFields:
				[
				{field:'cust_status',name:'客户业务状态',ctrlType:'easyui-combobox',hidden:false},
				{field:'cust_status_name',name:'客户业务状态名称',ctrlType:'easyui-validatebox',hidden:false},
		...
		actionForms:{
			'wmsc_ddic_cust_status_addData':{formId:'wmsc_ddic_cust_status_add_form',formUrl:'ui/view/ddic/wmsc_ddic_cust_status_add_form.html?actionId=wmsc_ddic_cust_status_add_form'},
			'wmsc_ddic_cust_status_getData':{formId:'wmsc_ddic_cust_status_query_form',formUrl:'ui/view/ddic/wmsc_ddic_cust_status_query_form.html?actionId=wmsc_ddic_cust_status_query_form'},
			'wmsc_ddic_cust_status_updateData':{formId:'wmsc_ddic_cust_status_update_form',formUrl:'ui/view/ddic/wmsc_ddic_cust_status_update_form.html?actionId=wmsc_ddic_cust_status_update_form'}
			},
		expellActions:{
			'wmsc_ddic_cust_status_searchData':'',
			'wmsc_ddic_cust_status_exportEntities':''
			}

};
var searchMeta = [
				{field:'cust_status',name:'客户业务状态',ctrlType:'easyui-combobox',ddicTable:'',domainId:'',searchFlag:'EQ',mustFlag:'N',defaultValue:''},
];
var bda_data_str_field = {
            wmsc_ddic_cust_status_addData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_cust_status_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_cust_status_exportData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_cust_status_getData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_cust_status_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_ddic_cust_status_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_ddic_cust_status_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_ddic_cust_status_getData'];
					techParam.initActionId = 'wmsc_ddic_cust_status_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
