...
var listTemplate = '#wmsc_ddic_close_code_list';
var formSearchTemplate = '#wmsc_ddic_close_code_searchForm';
var gridMenuId = '#wmsc_ddic_close_code_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_ddic_close_code_list',
		objectName:'仓库事务完结编码',
		objectKeys:['close_code'],
		objectFields:
				[
				{field:'close_code',name:'事务完结编码',ctrlType:'easyui-combobox',hidden:false},
				{field:'close_code_name',name:'事务完结编码名称',ctrlType:'easyui-validatebox',hidden:false},
		...
		actionForms:{
			'wmsc_ddic_close_code_addData':{formId:'wmsc_ddic_close_code_add_form',formUrl:'ui/view/ddic/wmsc_ddic_close_code_add_form.html?actionId=wmsc_ddic_close_code_add_form'},
			'wmsc_ddic_close_code_getData':{formId:'wmsc_ddic_close_code_query_form',formUrl:'ui/view/ddic/wmsc_ddic_close_code_query_form.html?actionId=wmsc_ddic_close_code_query_form'},
			'wmsc_ddic_close_code_updateData':{formId:'wmsc_ddic_close_code_update_form',formUrl:'ui/view/ddic/wmsc_ddic_close_code_update_form.html?actionId=wmsc_ddic_close_code_update_form'}
			},
		expellActions:{
			'wmsc_ddic_close_code_searchData':'',
			'wmsc_ddic_close_code_exportEntities':''
			}

};
var searchMeta = [
				{field:'close_code',name:'事务完结编码',ctrlType:'easyui-combobox',ddicTable:'',domainId:'',searchFlag:'EQ',mustFlag:'N',defaultValue:''},
];
var bda_data_str_field = {
            wmsc_ddic_close_code_addData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_close_code_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_close_code_exportData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_close_code_getData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_close_code_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_ddic_close_code_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_ddic_close_code_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_ddic_close_code_getData'];
					techParam.initActionId = 'wmsc_ddic_close_code_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
