//-------------------- 代码可变区
//-------------------- 代码可变区
var formTemplate = '#form_wmsc_ddic_close_code';
var fields = 
				[
				{field:'close_code',name:'事务完结编码',ctrlType:'easyui-combobox',ddicTable:'',domainId:'',display:'Y',mustFlag:'Y',minLen:0,maxLen:6,precise:0,readOnly:'N',defaultValue:''},
				{field:'close_code_name',name:'事务完结编码名称',ctrlType:'easyui-validatebox',ddicTable:'',domainId:'',display:'Y',mustFlag:'N',minLen:0,maxLen:32,precise:0,readOnly:'N',defaultValue:''},
				];
