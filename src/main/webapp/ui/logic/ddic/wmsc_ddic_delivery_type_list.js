...
var listTemplate = '#wmsc_ddic_delivery_type_list';
var formSearchTemplate = '#wmsc_ddic_delivery_type_searchForm';
var gridMenuId = '#wmsc_ddic_delivery_type_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_ddic_delivery_type_list',
		objectName:'物流产品类型',
		objectKeys:['delivery_type'],
		objectFields:
				[
				{field:'delivery_type',name:'物流产品类型',ctrlType:'easyui-combobox',hidden:false},
				{field:'delivery_type_name',name:'物流产品类型名称',ctrlType:'easyui-validatebox',hidden:false},
		...
		actionForms:{
			'wmsc_ddic_delivery_type_addData':{formId:'wmsc_ddic_delivery_type_add_form',formUrl:'ui/view/ddic/wmsc_ddic_delivery_type_add_form.html?actionId=wmsc_ddic_delivery_type_add_form'},
			'wmsc_ddic_delivery_type_getData':{formId:'wmsc_ddic_delivery_type_query_form',formUrl:'ui/view/ddic/wmsc_ddic_delivery_type_query_form.html?actionId=wmsc_ddic_delivery_type_query_form'},
			'wmsc_ddic_delivery_type_updateData':{formId:'wmsc_ddic_delivery_type_update_form',formUrl:'ui/view/ddic/wmsc_ddic_delivery_type_update_form.html?actionId=wmsc_ddic_delivery_type_update_form'}
			},
		expellActions:{
			'wmsc_ddic_delivery_type_searchData':'',
			'wmsc_ddic_delivery_type_exportEntities':''
			}

};
var searchMeta = [
				{field:'delivery_type',name:'物流产品类型',ctrlType:'easyui-combobox',ddicTable:'',domainId:'',searchFlag:'EQ',mustFlag:'N',defaultValue:''},
];
var bda_data_str_field = {
            wmsc_ddic_delivery_type_addData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_delivery_type_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_delivery_type_exportData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_delivery_type_getData : function (buttonId,actionUrl){
            ...
            wmsc_ddic_delivery_type_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_ddic_delivery_type_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_ddic_delivery_type_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_ddic_delivery_type_getData'];
					techParam.initActionId = 'wmsc_ddic_delivery_type_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
