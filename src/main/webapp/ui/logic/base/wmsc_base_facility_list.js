...
var listTemplate = '#wmsc_base_facility_list';
var formSearchTemplate = '#wmsc_base_facility_searchForm';
var gridMenuId = '#wmsc_base_facility_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_base_facility_list',
		objectName:'巴枪设备注册',
		objectKeys:['op_equip_id'],
		objectFields:
				[
				{field:'op_equip_id',name:'设备id',ctrlType:'easyui-validatebox',hidden:false},
				...
				{field:'op_worker_id',name:'默认作业人员',ctrlType:'easyui-validatebox',hidden:false},
				{field:'register_time',name:'注册时间',ctrlType:'easyui-datetimebox',hidden:false},
				{field:'equip_status_name',name:'设备状态',ctrlType:'easyui-validatebox',hidden:false},
				{field:'equip_status',name:'设备状态',ctrlType:'easyui-combobox',hidden:true},
				{field:'equip_vendor',name:'设备产商',ctrlType:'easyui-validatebox',hidden:false},
		...
		actionForms:{
			'wmsc_base_facility_addData':{formId:'wmsc_base_facility_add_form',formUrl:'ui/view/base/wmsc_base_facility_add_form.html?actionId=wmsc_base_facility_add_form'},
			'wmsc_base_facility_getData':{formId:'wmsc_base_facility_query_form',formUrl:'ui/view/base/wmsc_base_facility_query_form.html?actionId=wmsc_base_facility_query_form'},
			'wmsc_base_facility_updateData':{formId:'wmsc_base_facility_update_form',formUrl:'ui/view/base/wmsc_base_facility_update_form.html?actionId=wmsc_base_facility_update_form'}
			},
		expellActions:{
			'wmsc_base_facility_searchData':'',
			'wmsc_base_facility_exportEntities':''
			}

};
var searchMeta = [
				{field:'op_equip_id',name:'设备id',ctrlType:'easyui-validatebox',ddicTable:'',domainId:'',searchFlag:'EQ',mustFlag:'N',defaultValue:''},
];
var bda_data_str_field = {
            wmsc_base_facility_addData : function (buttonId,actionUrl){
            ...
            wmsc_base_facility_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_base_facility_exportData : function (buttonId,actionUrl){
            ...
            wmsc_base_facility_getData : function (buttonId,actionUrl){
            ...
            wmsc_base_facility_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_base_facility_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_base_facility_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_base_facility_getData'];
					techParam.initActionId = 'wmsc_base_facility_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
