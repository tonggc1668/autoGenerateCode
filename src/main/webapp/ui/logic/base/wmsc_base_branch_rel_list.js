...
var listTemplate = '#wmsc_base_branch_rel_list';
var formSearchTemplate = '#wmsc_base_branch_rel_searchForm';
var gridMenuId = '#wmsc_base_branch_rel_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_base_branch_rel_list',
		objectName:'仓网点链式关系',
		objectKeys:['sup_org_id','org_id'],
		objectFields:
				[
				{field:'sup_org_id',name:'上级仓网点id',ctrlType:'easyui-numberbox',hidden:false},
				{field:'org_id',name:'本级仓网点id',ctrlType:'easyui-numberbox',hidden:false},
				{field:'sup_level',name:'上级仓网点级别',ctrlType:'easyui-numberbox',hidden:false},
				{field:'org_level',name:'本级仓网点级别',ctrlType:'easyui-numberbox',hidden:false},
				{field:'org_rel_seq',name:'仓网点层级链',ctrlType:'easyui-validatebox',hidden:false},
		...
		actionForms:{
			'wmsc_base_branch_rel_addData':{formId:'wmsc_base_branch_rel_add_form',formUrl:'ui/view/base/wmsc_base_branch_rel_add_form.html?actionId=wmsc_base_branch_rel_add_form'},
			'wmsc_base_branch_rel_getData':{formId:'wmsc_base_branch_rel_query_form',formUrl:'ui/view/base/wmsc_base_branch_rel_query_form.html?actionId=wmsc_base_branch_rel_query_form'},
			'wmsc_base_branch_rel_updateData':{formId:'wmsc_base_branch_rel_update_form',formUrl:'ui/view/base/wmsc_base_branch_rel_update_form.html?actionId=wmsc_base_branch_rel_update_form'}
			},
		expellActions:{
			'wmsc_base_branch_rel_searchData':'',
			'wmsc_base_branch_rel_exportEntities':''
			}

};
var searchMeta = [
				{field:'sup_org_id',name:'上级仓网点id',ctrlType:'easyui-numberbox',ddicTable:'',domainId:'',searchFlag:'EQ',mustFlag:'N',defaultValue:''},
				{field:'org_id',name:'本级仓网点id',ctrlType:'easyui-numberbox',ddicTable:'',domainId:'',searchFlag:'EQ',mustFlag:'N',defaultValue:''},
];
var bda_data_str_field = {
            wmsc_base_branch_rel_addData : function (buttonId,actionUrl){
            ...
            wmsc_base_branch_rel_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_base_branch_rel_exportData : function (buttonId,actionUrl){
            ...
            wmsc_base_branch_rel_getData : function (buttonId,actionUrl){
            ...
            wmsc_base_branch_rel_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_base_branch_rel_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_base_branch_rel_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_base_branch_rel_getData'];
					techParam.initActionId = 'wmsc_base_branch_rel_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
