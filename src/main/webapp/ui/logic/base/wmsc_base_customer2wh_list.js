...
var listTemplate = '#wmsc_base_customer2wh_list';
var formSearchTemplate = '#wmsc_base_customer2wh_searchForm';
var gridMenuId = '#wmsc_base_customer2wh_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_base_customer2wh_list',
		objectName:'仓客户与仓库关系',
		objectKeys:['customer_id'],
		objectFields:
				[
				{field:'customer_id',name:'仓客户id',ctrlType:'easyui-numberbox',hidden:false},
				{field:'busi_wh_id',name:'业务关联仓库',ctrlType:'easyui-numberbox',hidden:false},
		...
		actionForms:{
			'wmsc_base_customer2wh_addData':{formId:'wmsc_base_customer2wh_add_form',formUrl:'ui/view/base/wmsc_base_customer2wh_add_form.html?actionId=wmsc_base_customer2wh_add_form'},
			'wmsc_base_customer2wh_getData':{formId:'wmsc_base_customer2wh_query_form',formUrl:'ui/view/base/wmsc_base_customer2wh_query_form.html?actionId=wmsc_base_customer2wh_query_form'},
			'wmsc_base_customer2wh_updateData':{formId:'wmsc_base_customer2wh_update_form',formUrl:'ui/view/base/wmsc_base_customer2wh_update_form.html?actionId=wmsc_base_customer2wh_update_form'}
			},
		expellActions:{
			'wmsc_base_customer2wh_searchData':'',
			'wmsc_base_customer2wh_exportEntities':''
			}
...
var bda_data_str_field = {
            wmsc_base_customer2wh_addData : function (buttonId,actionUrl){
            ...
            wmsc_base_customer2wh_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_base_customer2wh_exportData : function (buttonId,actionUrl){
            ...
            wmsc_base_customer2wh_getData : function (buttonId,actionUrl){
            ...
            wmsc_base_customer2wh_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_base_customer2wh_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_base_customer2wh_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_base_customer2wh_getData'];
					techParam.initActionId = 'wmsc_base_customer2wh_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
