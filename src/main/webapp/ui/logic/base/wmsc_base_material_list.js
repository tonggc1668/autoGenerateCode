...
var listTemplate = '#wmsc_base_material_list';
var formSearchTemplate = '#wmsc_base_material_searchForm';
var gridMenuId = '#wmsc_base_material_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_base_material_list',
		objectName:'货品信息',
		objectKeys:['mat_id'],
		objectFields:
				[
				...
				{field:'mat_code',name:'货品编码',ctrlType:'easyui-validatebox',hidden:false},
				{field:'mat_sku',name:'货品sku',ctrlType:'easyui-validatebox',hidden:false},
				{field:'mat_name',name:'货品简称',ctrlType:'easyui-validatebox',hidden:false},
				{field:'mat_full_name',name:'货品全称',ctrlType:'easyui-validatebox',hidden:false},
				{field:'mat_en_name',name:'货品英文名',ctrlType:'easyui-validatebox',hidden:false},
				{field:'mat_hint_code',name:'货品助记码',ctrlType:'easyui-validatebox',hidden:false},
				{field:'mat_barcode',name:'货品条码',ctrlType:'easyui-validatebox',hidden:false},
				{field:'mat_gtin',name:'GTIN全球货品码',ctrlType:'easyui-validatebox',hidden:false},
				{field:'consume_flag_name',name:'耗材标识',ctrlType:'easyui-validatebox',hidden:false},
				{field:'consume_flag',name:'耗材标识',ctrlType:'easyui-combobox',hidden:true},
				{field:'mat_type',name:'货品类别',ctrlType:'easyui-combobox',hidden:false},
				{field:'mat_spec',name:'规格型号',ctrlType:'easyui-validatebox',hidden:false},
				{field:'mat_weight',name:'单品重量',ctrlType:'easyui-numberbox',hidden:false},
				{field:'mat_width',name:'货品宽',ctrlType:'easyui-numberbox',hidden:false},
				{field:'mat_high',name:'货品高',ctrlType:'easyui-numberbox',hidden:false},
				{field:'mat_length',name:'货品长',ctrlType:'easyui-numberbox',hidden:false},
				{field:'mat_cubage',name:'单品体积',ctrlType:'easyui-numberbox',hidden:false},
				{field:'mat_unit_name',name:'计量单位',ctrlType:'easyui-validatebox',hidden:false},
				{field:'mat_unit',name:'计量单位',ctrlType:'easyui-combobox',hidden:true},
				{field:'mat_prise',name:'货品单价',ctrlType:'easyui-numberbox',hidden:false},
				{field:'mat_insure_fee',name:'保险费',ctrlType:'easyui-numberbox',hidden:false},
				{field:'mat_life_days',name:'货品保值期',ctrlType:'easyui-numberbox',hidden:false},
				{field:'mat_abc',name:'ABC分类',ctrlType:'easyui-validatebox',hidden:false},
		...
		actionForms:{
			'wmsc_base_material_addData':{formId:'wmsc_base_material_add_form',formUrl:'ui/view/base/wmsc_base_material_add_form.html?actionId=wmsc_base_material_add_form'},
			'wmsc_base_material_getData':{formId:'wmsc_base_material_query_form',formUrl:'ui/view/base/wmsc_base_material_query_form.html?actionId=wmsc_base_material_query_form'},
			'wmsc_base_material_updateData':{formId:'wmsc_base_material_update_form',formUrl:'ui/view/base/wmsc_base_material_update_form.html?actionId=wmsc_base_material_update_form'}
			},
		expellActions:{
			'wmsc_base_material_searchData':'',
			'wmsc_base_material_exportEntities':''
			}

};
var searchMeta = [
				{field:'mat_id',name:'货品id',ctrlType:'easyui-numberbox',ddicTable:'',domainId:'',searchFlag:'EQ',mustFlag:'N',defaultValue:''},
];
var bda_data_str_field = {
            wmsc_base_material_addData : function (buttonId,actionUrl){
            ...
            wmsc_base_material_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_base_material_exportData : function (buttonId,actionUrl){
            ...
            wmsc_base_material_getData : function (buttonId,actionUrl){
            ...
            wmsc_base_material_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_base_material_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_base_material_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_base_material_getData'];
					techParam.initActionId = 'wmsc_base_material_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
