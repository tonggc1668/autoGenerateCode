...
var listTemplate = '#wmsc_base_carrior_list';
var formSearchTemplate = '#wmsc_base_carrior_searchForm';
var gridMenuId = '#wmsc_base_carrior_list_menu';
//当前用户需要特殊处理的按钮，不在menubar上显示的 
var metaData = {
		objectId:'wmsc_base_carrior_list',
		objectName:'承运商信息',
		objectKeys:['carrior_id'],
		objectFields:
				[
				...
				{field:'comp_name',name:'公司名称',ctrlType:'easyui-validatebox',hidden:false},
				{field:'comp_contactor',name:'公司联系人',ctrlType:'easyui-validatebox',hidden:false},
				{field:'comp_mobile',name:'公司联系手机',ctrlType:'easyui-numberbox',hidden:false},
				{field:'comp_country',name:'所属国家',ctrlType:'easyui-validatebox',hidden:false},
				{field:'comp_province',name:'所属省',ctrlType:'easyui-validatebox',hidden:false},
				{field:'comp_city',name:'所属市',ctrlType:'easyui-validatebox',hidden:false},
				{field:'comp_area',name:'所属区',ctrlType:'easyui-validatebox',hidden:false},
				{field:'comp_address',name:'具体地址',ctrlType:'easyui-validatebox',hidden:false},
				...
				{field:'comp_status',name:'公司状态',ctrlType:'easyui-combobox',hidden:false},
		...
		actionForms:{
			'wmsc_base_carrior_addData':{formId:'wmsc_base_carrior_add_form',formUrl:'ui/view/base/wmsc_base_carrior_add_form.html?actionId=wmsc_base_carrior_add_form'},
			'wmsc_base_carrior_getData':{formId:'wmsc_base_carrior_query_form',formUrl:'ui/view/base/wmsc_base_carrior_query_form.html?actionId=wmsc_base_carrior_query_form'},
			'wmsc_base_carrior_updateData':{formId:'wmsc_base_carrior_update_form',formUrl:'ui/view/base/wmsc_base_carrior_update_form.html?actionId=wmsc_base_carrior_update_form'}
			},
		expellActions:{
			'wmsc_base_carrior_searchData':'',
			'wmsc_base_carrior_exportEntities':''
			}

};
var searchMeta = [
				{field:'carrior_id',name:'承运商id',ctrlType:'easyui-numberbox',ddicTable:'',domainId:'',searchFlag:'EQ',mustFlag:'N',defaultValue:''},
];
var bda_data_str_field = {
            wmsc_base_carrior_addData : function (buttonId,actionUrl){
            ...
            wmsc_base_carrior_deleteData : function (buttonId,actionUrl){
            ...
            wmsc_base_carrior_exportData : function (buttonId,actionUrl){
            ...
            wmsc_base_carrior_getData : function (buttonId,actionUrl){
            ...
            wmsc_base_carrior_importData : function (buttonId,actionUrl){
            	var form = {};							
            ...
            wmsc_base_carrior_searchData : function (buttonId,actionUrl){
				var params = $$.serializeToJson(formSearchTemplate);
				var conditions = [];
				var search;
            ...
            wmsc_base_carrior_updateData : function (buttonId,actionUrl){
			var selectRow = $$.getSingleSelectRow(metaData.objectId, "请选择你要编辑的"+metaData.objectName);
		    	if(selectRow){
					...
					techParam.initActionUrl = appId + authActions['wmsc_base_carrior_getData'];
					techParam.initActionId = 'wmsc_base_carrior_getData';
					techParam.actionId = form.formId;
					techParam.mode = 'edit';
					techParam.refActionUrl = actionUrl;
					techParam.refActionId = buttonId;
