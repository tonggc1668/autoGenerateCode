...
public class CommonPageParser
{
  ...
  private static boolean isReplace = CodeResourceUtil.ISREPLACE;

  static
  {
    try
    {
      String templateBasePath = CodeResourceUtil.TEMPLATEPATH;
  ...
  public static void WriterPage(VelocityContext context, String templateName, String targetFile)
  {
    try
    {
